...
const SkillsPage: FC = () => (
  <main className={styles.content}>
    <p>
      ...
      react-hook-form, react-query, zod, REST API.
    </p>
    <p>
    ...
    <div className={styles.content__project}>
      ...
      <p>
        Задачи: разработка компонентов на основое N2OFramework (внутренний
        продукт компании) по макетам заказчика
      </p>
      <p>Стек: React, TypeScript, material-ui, N2OFramework</p>
    ...
    <div className={styles.content__project}>
      ...
      <p>
        Задачи: разработка личного кабинета арбитражного управляющего -
    ...
    <div className={styles.content__project}>
      ...
      <p>
        Задачи: разработка сайта с планами этажей офиса и рассадки сотрудников,
